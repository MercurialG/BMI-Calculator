...
const kBigText = TextStyle(fontSize: 50, fontWeight: FontWeight.w900,);
const kBigButtonTextStyle = TextStyle(fontSize: 25, fontWeight: FontWeight.bold);
...
const kBodyTextStyle = TextStyle(fontSize: 25);